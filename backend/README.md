...
## Project Structure
    ...
    ├── ravinder_test_app_d_35910  # Django project configurations
...
1. Clone this repo and `cd ravinder_test_app_d_35910`
...
2. Clone this repo and `cd ravinder_test_app_d_35910`
